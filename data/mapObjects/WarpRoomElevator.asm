WarpRoomElevator_Object:
	...
	db 2 ; signs
	sign  4,  1, 2 ; WarpRoomElevatorText1
	sign  5,  1, 3 ; WarpRoomElevatorText2

	db 1 ; objects
	object SPRITE_BUG_CATCHER,  9,  1, STAY, DOWN, 1

	; warp-to
	warp_to  4,  5, WARP_ROOM_ELEVATOR_WIDTH ; Irrelevant
	warp_to  5,  5, WARP_ROOM_ELEVATOR_WIDTH ; Irrelevant
